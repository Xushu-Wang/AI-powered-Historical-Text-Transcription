...
#Engine name
engine_name = Label(root, text = "OCR Engine: Tesseract 5.1.0", font = ("Cormorant SC", 20))
engine_name.grid(column = 0, row = 2)
...
main_content = Frame(root, width=1100, height=400, bg="#87CEFA")
